...
import { faHome, faBook, faPencil } from "@fortawesome/free-solid-svg-icons";
      ...
      <div className={style.Nav}>
        ...
        <Link href="/diary" prefetch={true}>
          <a>
            ...
            />
            <h4 className={router.pathname == "/diary" ? style.Active : ""}>
              confessions
            </h4>
          </a>
        </Link>
        <Link href="/write" prefetch={true}>
          <a>
            ...
            />
            <h4 className={router.pathname == "/write" ? style.Active : ""}>
              write
            </h4>
          </a>
        </Link>
